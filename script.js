...
const traduction = {
  en: {
    ...
    "rps-desc" : "A game where users play against the computer in a classic best-of-five matchup.",
  ...
  fr: {
    ...
    "rps-title" : "Roche, Papier, Ciseaux",
    "rps-desc" : "Jeu où les utilisateurs jouent contre l'ordinateur dans un classique match au meilleur des cinq.",
